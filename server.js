var express = require("express") //this is part of building an express java webpage after installing express as 'require' is a function for running javascript code on a server and const declares a variable called express.
